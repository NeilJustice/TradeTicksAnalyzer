...
TEST(ZenUnitEqualizer_ThrowsZenUnitAnomalyIfAnyFieldNotEqual)
{
   ...
   ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(TradeTicksAnalyzerArgMaps, docoptArgs_calculate_trade_tick_latency_statistics, nonEmptyMap);
...
TEST(TestableRandomTradeTicksAnalyzerArgMaps_ReturnsTradeTicksAnalyzerArgMapsWithAllRandomFields)
{
   ...
   IS_NOT_EMPTY(randomTradeTicksAnalyzerArgMaps.docoptArgs_calculate_trade_tick_latency_statistics);
