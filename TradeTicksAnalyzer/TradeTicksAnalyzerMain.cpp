...
// Production Args
// ===============
// find-possible-bad-text-trade-ticks --trading-logs-input-folder=X:\Trading\TradingProgram\PaperTradingLogsReplay --date=2025-12-12F --run-number=2 --bad-tick-change-percent-threshold=1.0 --trading-logs-output-folder=X:\Trading\TradingProgram\PaperTradingLogsReplay
// find-possible-bad-text-trade-ticks --trading-logs-input-folder=X:\Trading\TradingProgram\PaperTradingLogsReplay --date=2025-12-12F --run-number=2 --bad-tick-change-percent-threshold=1.0 --trading-logs-output-folder=X:\Trading\TradingProgram\PaperTradingLogsReplay --parallel
